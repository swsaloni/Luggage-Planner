 ...
 */
public class MyAdapter  extends RecyclerView.Adapter<MyAdapter.PredictionHolder> implements Filterable
{
    ...
    public MyAdapter(Context context, int resource, GoogleApiClient googleApiClient,
